...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.orderService.findOrderByEmail(this.userRegEmail).subscribe(res => {
      if(res==null) {
        this.noPastOrders = true;
      } else {
        this.orders = res;
      }},
      err =>  this.noPastOrders = true
    );
  }
  ...
  onRegister() {
    ...
    this.memberService.addNewMember(this.model).subscribe(
      res => {
        this.showAlert(this.regMessage)
  ...
  showDisplayOrders() {
    if(!this.sd) {
      this.pastOrder = "Collapse Orders";
      this.sd = true;
    } else if (this.sd) {
      this.pastOrder = "Display Orders";
      this.sd = false;
